...
const SingleGridItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-white shadow-1 min-h-[270px] max-w-[500px] mb-4">
        <Image src={item.imgs.previews[0]} alt="" width={250} height={250} className="w-full h-full object-cover"/>
