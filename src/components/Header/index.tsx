...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {/* <!-- header top start --> */}
      <div
        className={`flex  lg:flex-row justify-between ease-out duration-200 ${
      ...
      >
        ...
        >
          ...
          <ul className={`hidden md:flex items-center gap-5 sm:gap-10 flex-shrink-0 ${
            ...
            <Link href="/inspiration" className={stickyMenu ? "text-dark" : "text-white"}>
            Inspiration
            </Link>
        ...
        <div className=" xl:flex items-center gap-3.5">
          ...
          <path
            ...
            className={stickyMenu ? "fill-[#000000]" : "fill-white"}
          />
          <path
        ...
        {/* <!-- divider --> */}
        <span
          className={`hidden xl:block w-px h-7.5 ${
          stickyMenu ? "bg-gray-4" : "bg-white/30"
          }`}
        ></span>
